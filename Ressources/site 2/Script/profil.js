$(document).ready(function() {
    ...
    $("#photo").submit(function (event){
        ...
        $.ajax({
            url: '../../api/profil/photo.php?mail='+$("#email").attr("placeholder")+'&ancienne='+$("#image_profil").attr("src"), // <-- point to server-side PHP script
