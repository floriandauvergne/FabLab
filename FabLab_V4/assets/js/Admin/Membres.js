...
//Requête pour récupérer la liste des Membres
    var request = $.ajax({
        method: "GET",
        url: "http://51.210.151.13/btssnir/projets2022/fablab/api/membre/recuperer.php",
        data: {},
        dataType: "json"
    });
    request.done(function (msg) {
        ...
        for (let i = 0; i < (msg.length - 1); i++) {
            ...
            $("#" + msg[i].ID + " button").click(function () {
                ...
                var request = $.ajax({
                    method: "POST",
                    url: "http://51.210.151.13/btssnir/projets2022/fablab/api/membre/modifier.php",
...
/////////CODE SUPPRESSION/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            $("#" + msg[i].ID + " div").click(function () {
                if (window.confirm("Voulez-vous supprimer ce membre ?")) {
                    request = $.ajax({
                        method: "POST",
                        url: "http://51.210.151.13/btssnir/projets2022/fablab/api/membre/supprimer.php",
                        data: {
                            id: msg[i].ID
                        },
                        dataType: "json"
    ...
    $("#Ajouter-un-membre-confirmer").click(function () {
        ...
        if ($("#Mail-Nouveau").val() != "" && $("#Nom-Nouveau").val() != "" && $("#Grade-Nouveau").val() != "" && $("#Carte-Nouveau").val() != "" && $("#Age-Nouveau").val() != "" && $("#Type-Nouveau").val() != "") {
            var request = $.ajax({
                method: "POST",
                url: "http://51.210.151.13/btssnir/projets2022/fablab/api/membre/ajouter.php",
                data: {
                    Nom: $("#Nom-Nouveau").val(),
